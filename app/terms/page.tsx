...
export const metadata: Metadata = {
  title: 'Terms of Service | Men at Work Traffic Management',
  description: 'Terms governing the use of the Men at Work Traffic Management website and services.',
  alternates: {
    canonical: '/terms',
  },
}
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
          ...
          <p className="reveal d2" style={{ fontSize: '1rem', lineHeight: 1.78, color: 'var(--muted)', maxWidth: '540px', marginTop: '20px' }}>
            Terms governing the use of the Men at Work Traffic Management website and services.
          </p>
        </div>
      </section>

      {/* ── CONTENT ── */}
      <section style={{ background: 'var(--navy)', padding: '80px 0 120px' }} aria-label="Terms of Service content">
        <div style={{ maxWidth: '760px', margin: '0 auto', padding: '0 24px' }}>
          ...
          {[
            ...
            },
            {
              ...
              body: 'This website is provided for informational purposes relating to the services offered by Men at Work Traffic Management. You agree to use the site only for lawful purposes and in a manner that does not infringe the rights of others.',
            },
            {
              heading: 'Intellectual Property',
              body: 'All content on this website, including text, images, logos, and design elements, is the property of Men at Work Traffic Management or its licensors and is protected by applicable copyright and intellectual property laws.',
            },
            {
              heading: 'Service Enquiries',
              body: 'Submitting a quote request or contact form through this website does not constitute a binding contract or guarantee of service. All service agreements are subject to separate terms confirmed in writing by Men at Work Traffic Management.',
            },
            {
              heading: 'Limitation of Liability',
              body: 'Men at Work Traffic Management makes no warranties regarding the accuracy or completeness of information on this website. To the extent permitted by law, we accept no liability for any loss or damage arising from your use of the site.',
            },
            {
            ...
            {
              heading: 'Contact',
              body: 'For questions about these terms, contact us at office@menatwork.co.nz or call 0800 636 289.',
            },
          ].map(({ heading, body }) => (
