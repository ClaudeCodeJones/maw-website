...
export const metadata: Metadata = {
  title: 'Privacy Policy | Men at Work Traffic Management',
  description: 'How Men at Work Traffic Management collects, uses and protects information provided through our website.',
  alternates: {
    canonical: '/privacy',
  },
}
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
          ...
          <p className="reveal d2" style={{ fontSize: '1rem', lineHeight: 1.78, color: 'var(--muted)', maxWidth: '540px', marginTop: '20px' }}>
            How Men at Work Traffic Management collects, uses and protects information provided through our website.
          </p>
        </div>
      </section>

      {/* ── CONTENT ── */}
      <section style={{ background: 'var(--navy)', padding: '80px 0 120px' }} aria-label="Privacy Policy content">
          ...
          {[
            {
              ...
              body: 'Men at Work Traffic Management is committed to protecting your privacy. This policy outlines how we collect, use, and safeguard personal information when you use our website or contact us about our services.',
            },
            {
            ...
            {
              heading: 'Your Rights',
              body: 'You have the right to access, correct, or request deletion of personal information we hold about you. To make a request, contact us at office@menatwork.co.nz.',
            },
            {
              heading: 'Contact',
              body: 'If you have any questions about this privacy policy or how we handle your information, please contact us at office@menatwork.co.nz or call 0800 636 289.',
            },
          ].map(({ heading, body }) => (
