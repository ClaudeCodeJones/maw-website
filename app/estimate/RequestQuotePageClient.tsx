              ...
              <div key={n} style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ display: 'flex', flexDirection: 'column' as const, alignItems: 'center', gap: '6px' }}>
                  <div style={{
                    ...
                    background: step >= n ? 'var(--orange)' : 'rgba(255,255,255,0.08)',
                ...
                {i === 0 && (
                  <div style={{ width: '72px', height: '1px', background: step >= 2 ? 'var(--orange)' : 'rgba(255,255,255,0.12)', margin: '0 8px 20px', flexShrink: 0, transition: 'background 0.2s ease' }} />
                )}
              </div>
            ))}
          </div>
          ...
          >
            ...
            {step === 1 && (
              <div>
                ...
                <div style={fieldStyle}>
                  <label htmlFor="branch" style={labelStyle}>Men at Work Branch *</label>
                ...
                <div style={fieldStyle}>
                  <label style={labelStyle}>Do you have an account with Men at Work currently? *</label>
                  <RadioGroup
                    name="hasAccount"
                    value={s1.hasAccount}
                  ...
                  {s1.hasAccount === 'unsure' && (
                    <p style={{ fontSize: '0.75rem', color: 'var(--muted)', marginTop: '16px', lineHeight: 1.5 }}>
            ...
            {step === 2 && (
              <div>
                ...
                <div style={fieldStyle}>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', fontSize: '0.9rem', color: 'var(--light)' }}>
                    <input
                      type="checkbox"
                      ...
                      style={{ accentColor: 'var(--orange)', width: '16px', height: '16px', cursor: 'pointer', flexShrink: 0 }}
                    />
