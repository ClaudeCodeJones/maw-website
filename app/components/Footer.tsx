    ...
    <footer id="footer">
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '64px 24px 32px' }}>
        ...
        <div className="footer-top-grid">
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '24px' }}>
              <a
                href="https://www.facebook.com/menatworknz/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="footer-social"
                style={{ width: '36px', height: '36px', background: 'var(--navy-mid)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
              >
              ...
              <a
                href="https://nz.linkedin.com/company/men-at-work-traffic-management-new-zealand"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="footer-social"
          ...
          <div>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '11px', listStyle: 'none' }}>
              {[
                { label: 'Onsite Traffic Management', href: '/#service-roadworks' },
        ...
        <div style={{ paddingTop: '28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
          <p style={{ fontSize: '0.78rem', color: 'var(--muted)' }}>© {new Date().getFullYear()} MW Traffic Management. All rights reserved.</p>
